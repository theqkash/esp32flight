...
"</div><div style='margin-top:14px'><button onclick='saveCfg()'>Save and restart</button> <span id='cfgstat' class='dim'></span></div></div>"
...
"document.getElementById('c_night_end').value=mm(c.night_end_min||390);}catch(e){}}"
